        ...
        <div className={`px-3 ${styles.docpage}`}>
          ...
          <div
            ...
            <div style={{ border: "2px solid grey", padding: "5px", backgroundColor: theme === "light" ? "#38444d" : "#E7E9EB" }} >&lt;html&gt;
              ...
              <div style={{ margin: "15px", border: "2px solid grey", padding: "5px" }} >&lt;body&gt;
                <div style={{ margin: "15px", border: "2px solid grey", padding: "5px" }} >
                  <div style={{ margin: "15px", border: "2px solid grey", padding: "5px" }}>&lt;h1&gt;This is a heading&lt;/h1&gt;</div>
                  <div style={{ margin: "15px", border: "2px solid grey", padding: "5px" }}>&lt;p&gt;This is a paragraph.&lt;/p&gt;</div>
                  <div style={{ margin: "15px", border: "2px solid grey", padding: "5px" }}>&lt;p&gt;This is another paragraph.&lt;/p&gt;</div>
                </div>
                &lt;/body&gt;
              </div>
              &lt;/html&gt;
